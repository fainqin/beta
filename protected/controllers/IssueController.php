...
class IssueController extends Controller
{
    ...
    /**
     * @var private property containing the Issue model instance.
     */
    private $_model = null;
     ...
     * It is called before the actionCreate() action method is run in order to ensure a proper project content.
     */
    ...
    public function actionUpdate($id)
    {
        ...
        $model->project = $this->loadProject($model->project_id);
