CREATE DATABASE  IF NOT EXISTS `trackstar_dev` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `trackstar_dev`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: trackstar_dev
-- ------------------------------------------------------
...
-- Dump completed on 2014-09-19 18:00:50
