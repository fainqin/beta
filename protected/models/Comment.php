...
class Comment extends TrackStarActiveRecord {
    ...
    /*
     * Retuns the static model with most recent comments order by comment.create_time.
     * In a relational AR query in Yii, the alias name for the primary table (tbl_comment) is fixed as t.
     */
